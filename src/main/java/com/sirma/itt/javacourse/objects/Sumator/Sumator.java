 ...
 * 
 * sum(a,b) where a,b can be Integer,Float,String,BigInteger,BigDecimal
 * 
 * @author Radoslav
 */
...
public class Sumator {
	...
	/**
	 * via the Sumator() constructor
	 * the initialization of variables is done
	 * 
	 */
	public Sumator(){
	...
	/**
	 * Making a new BigInteger object
	 * and add both @param a , @param b to it
	 * 
	 * 
	 * @param a
	 * 		BigInteger object
	 * @param b
	 * 		BigInteger object
	 * @return String representation of the new BigInteger object in which we kept the sum
	 */
	...
	/**
	 * Summing 2 string numbers, requires own implementation or 
	 * making a BigInteger object with the string's value
	 * Here we use the build in java.math.BigInteger
	 * 
	 * @param a
	 * 		number is passed in String
	 * @param b
	 * 		number is passed in String
